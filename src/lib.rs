...
//!
//! assert_eq!(Relation::from_ranges(2.0..=4.0, 5.0..=8.0), Ok(Relation::Precedes { is_inverted: false }));
//! assert_eq!(Relation::from_ranges(2.0..=5.0, 5.0..=8.0), Ok(Relation::Meets { is_inverted: false }));
//! assert_eq!(Relation::from_ranges(2.0..=6.0, 5.0..=8.0), Ok(Relation::Overlaps { is_inverted: false }));
//! ```
//!
...
//! use allen_interval_relations::{FromRanges, Relation};
//!
//! assert_eq!(Relation::from_ranges(2..4, 5..8), Ok(Relation::Precedes { is_inverted: false }));
//! assert_eq!(Relation::from_ranges(2..5, 5..8), Ok(Relation::Meets { is_inverted: false }));
//! assert_eq!(Relation::from_ranges(2..6, 5..8), Ok(Relation::Overlaps { is_inverted: false }));
//! ```
//!
